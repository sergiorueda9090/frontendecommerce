...
import { createSlider, editSlider, clearDataSlider } from '../../store/slidersStore/SlidersThunks';
...
export const ModalBody = () => {
  ...
  const { dataSlider }     = useSelector( state => state.sliders );
  ...
  useEffect(() => {
    if(dataSlider.data.id === ""){

    }else{
      
      setFormData(dataSlider.data);

      setSelected(dataSlider.data.keywords)
  ...
  const handleEdit = async (e) => {
    ...
    if (isConfirmed) {
      ...
      const updatedFormData = {
        ...
        await dispatch(editSlider(updatedFormData));
  ...
  return (
    <>
      ...
      >
        ...
        <ModalHeader title={formData.id != "" ? "Editar Slider": "Crear Slider"}/>
