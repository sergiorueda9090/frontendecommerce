...
export const getAll = () => {
    ...
    return async (dispatch, getState) => {
        ...
        try {
            ...
            await dispatch(setDataDataSliders({ dataSliders: response.data.data, pager: response.data.pager }));
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
          ...
          try {
            ...
            // Despachar la acción setAuthenticated con la respuesta de la solicitud
            await dispatch(setDataSlider({ dataSlider:  response.data.data[0] }));
