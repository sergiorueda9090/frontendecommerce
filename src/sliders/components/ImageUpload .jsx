...
const ImageUpload = ({ onImageUpdate, image=""}) => {
      ...
      return new Promise((resolve, reject) => {
          Resizer.imageFileResizer(
              ...
              (uri) => {
                  ...
                  img.src = uri;
                  img.onload = () => {
                      if (img.width === 1920 && img.height === 358) {
                          resolve(true);
                      } else {
                          reject('Image dimensions must be 1920x358 pixels');
                      }
                  };
              },
              'base64'
    ...
    const showImage = () => {
      ...
      if(previewImage == ""){
        ...
        if (preview === "") {
          return (
            <Card sx={{ maxWidth: 1920 }}>
              <CardHeader />
              <Skeleton sx={{ width: 1920, height: 358 }} animation="wave" variant="rectangular" />
            </Card>
          );
        } else {
          return (
            <div sx={{ maxWidth: 1920 }}>
              <img src={preview} alt="Preview" style={{ width: '1920px', height: '358px', marginTop: '20px' }} />
            </div>
          );
        }
        ...
        return <>
                <div sx={{ maxWidth: 1920 }}>
                  <img src={previewImage} alt="Preview" style={{ width: '1920px', height: '358px', marginTop: '20px' }} />
                </div>
              </>  
